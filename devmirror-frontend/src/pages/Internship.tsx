...
const DEMO: InternshipData = {
  ...
  emails: [
    ...
    {
      id: '2',
      subject: 'Google Cloud Rapid Hackathon — You\'re registered!',
      from: 'noreply@googlecloud.com',
      date: '2026-06-01',
      snippet: 'You\'re registered! Here\'s everything you need for the Google Cloud Rapid Hackathon...',
      category: 'hackathon',
      ai_summary: 'Registration confirmed for Google Cloud Rapid Hackathon. Deadline June 11. DevMirror is your project — keep pushing.',
