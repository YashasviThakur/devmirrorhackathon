...
TECH_CATEGORIES: dict[str, list[str]] = {
    ...
    "ML / AI":           ["machine learning", "deep learning", "neural network", "nlp", "tensorflow", "pytorch", "llm", "transformer", "generative ai", "artificial intelligence", "gpt", "chatgpt", "openai", "langchain", "computer vision", "data science", "ai forgets", "how ai", " ai ", "ai tool", "ai model"],
